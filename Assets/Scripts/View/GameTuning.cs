...
namespace Puckmite.View
{
    ...
    public sealed class GameTuning : ScriptableObject
    {
        ...
        // 상점 진열 확률 (사용자 지정 2026-08-10 3차: 공격 25%·쉴드 25%·최대체력 25%·회복 15%·전투
        // 스톤 10%). The draw normalises by their sum, so live tuning cannot break it.
        [Range(0f, 1f)] public float OfferAttackChance = 0.25f;
        [Range(0f, 1f)] public float OfferShieldChance = 0.25f;
        [Range(0f, 1f)] public float OfferMaxHealthChance = 0.25f;
        [Range(0f, 1f)] public float OfferRunHealChance = 0.15f;
        [Range(0f, 1f)] public float OfferBattleStoneChance = 0.10f;
